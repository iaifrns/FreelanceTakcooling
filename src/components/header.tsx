    ...
    return (
        <>
            <ThemeProvider theme={defaultTheme}>
                <TopBar/>
                <Grid container component="main" sx={{ height: '100%', backgroundColor: '#1cbfff', backgroundImage: `url(${background})` }}>
                    <CssBaseline />
                    <Grid
                        container
                        xs={false}
                    ...
                    <Grid container xs={12} sm={8} md={6} bgcolor={'rgba(0,0,0,0)'} justifyContent={'center'} alignContent={'center'} >
                        <Grid container width={'80%'}>
                            ...
                            <Button variant="contained" style={{padding: 16, width:'25vh', backgroundColor: 'brown', marginBottom:16}}><Typography variant="subtitle1">Contact Us</Typography></Button>
                        </Grid>
